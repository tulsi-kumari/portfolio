    ...
    <aside className="w-full md:w-64 lg:w-72 shrink-0 md:sticky md:top-0 md:h-screen flex flex-col pt-10 pb-8 md:py-12 px-6 md:px-8 overflow-y-auto">
      <div className="flex flex-col sm:flex-row md:flex-col justify-between sm:items-center md:items-start gap-6">
        ...
        <div className="flex items-center md:items-start md:flex-col gap-4 md:gap-5">
          <div className="relative w-14 h-14 md:w-24 md:h-24 rounded-full shadow-sm ring-2 ring-line overflow-hidden shrink-0 bg-line">
            <Image src="/profile.jpg" alt="Tulsi Kumari" fill className="object-cover" />
            <span
              className="absolute bottom-0 right-0 md:bottom-1 md:right-1 w-3.5 h-3.5 md:w-4 md:h-4 rounded-full bg-emerald-500 ring-2 ring-paper"
        ...
        <div className="flex md:hidden items-center gap-3 text-xs font-medium">
          <a href="https://github.com/tulsi-kumari" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-line bg-ink/[0.02] text-ink/80 hover:bg-ink/[0.06] hover:text-ink transition-colors">GitHub</a>
          <a href="https://www.linkedin.com/in/kumari-tulsi/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-line bg-ink/[0.02] text-ink/80 hover:bg-ink/[0.06] hover:text-[#0A66C2] transition-colors">LinkedIn</a>
        </div>
      </div>

      <p className="hidden md:block mt-8 text-sm text-ink/80 leading-relaxed">
        I write about transaction boundaries, database performance, and distributed systems self-study.
      </p>

      {/* Navigation */}
      <nav className="flex md:flex-col items-center md:items-start gap-6 md:gap-4 mt-6 md:mt-8 text-sm font-medium pb-4 md:pb-0 border-b md:border-b-0 border-line overflow-x-auto w-full">
        ...
        <a href="/feed.xml" target="_blank" className="hidden md:flex text-muted hover:text-amber-600 transition-colors items-center gap-1.5 md:mt-2 shrink-0">
      ...
      <div className="hidden md:flex flex-col gap-3 mt-auto pt-8">
        <a href="mailto:tulsi.workk@gmail.com" className="text-sm font-medium text-accent hover:underline mb-2">tulsi.workk@gmail.com</a>
        <div className="flex gap-3">
          <a href="https://github.com/tulsi-kumari" target="_blank" rel="noreferrer" className="p-2.5 rounded-lg border border-line bg-ink/[0.02] text-ink/80 hover:bg-ink/[0.06] hover:text-ink transition-colors" title="GitHub">
          ...
          <a href="https://www.linkedin.com/in/kumari-tulsi/" target="_blank" rel="noreferrer" className="p-2.5 rounded-lg border border-line bg-ink/[0.02] text-ink/80 hover:bg-ink/[0.06] hover:text-[#0A66C2] transition-colors" title="LinkedIn">
